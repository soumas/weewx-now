...
import 'package:weewx_now_app/presentationOLD/bloc/add_endpoint_screen/add_endpoint_screen_bloc.dart';
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Card(
                    child: BlocBuilder<AddEndpointScreenBloc, AddEndpointScreenState>(
                        ...
                        if (state is EndpointCheckSuccess) {
                          ...
                          return Column(
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () => addEndpointScreenBloc.add(
                                  AddEndpoint(name: _endpointNameInputController.text, url: state.endpointUrl),
                                ),

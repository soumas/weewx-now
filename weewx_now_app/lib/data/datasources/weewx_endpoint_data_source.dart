...
abstract class WeewxEndpointDataSource {
  ...
  Future<List<WeewxEndpointModel>> addOrUpdateEndpoint(WeewxEndpointModel endpoint);
...
class WeewxEndpointDataSourceImpl extends WeewxEndpointDataSource {
  ...
  @override
  Future<List<WeewxEndpointModel>> addOrUpdateEndpoint(WeewxEndpointModel endpoint) async {

...
class SettingsModel {
  ...
  factory SettingsModel.fromMap(Map<String, dynamic> map) {
    return SettingsModel(
      ...
      webapp: Webapp.fromMap(map['webapp']),
...
class Webapp {
  ...
  factory Webapp.fromJson(String source) => Webapp.fromMap(json.decode(source));

  @override
  String toString() => 'Webapp(password: $password)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is Webapp && other.password == password;
  }
